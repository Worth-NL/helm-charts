...
![Version: 0.2.4-beta](https://img.shields.io/badge/Version-0.2.4--beta-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.6.0-patch.2](https://img.shields.io/badge/AppVersion-1.6.0--patch.2-informational?style=flat-square)
...
| image.tag | string | `"1.6.0-patch.2"` |  |

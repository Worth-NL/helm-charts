...
![Version: 0.16.3](https://img.shields.io/badge/Version-0.16.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.1](https://img.shields.io/badge/AppVersion-2.0.1-informational?style=flat-square)
...
| settings.omc.actor.id | string | `nil` | Required. The UUID of the actor registered in "OpenKlant" that every klantcontact OMC creates is linked to, so it has to be a real actor rather than any valid UUID |
